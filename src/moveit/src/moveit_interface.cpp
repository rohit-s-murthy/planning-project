...
{ 
 ...
 //  /* Sleep to give Rviz time to visualize the plan. */
	...
	group_variable_values[0] = 5.0;	//base_x
	// group_variable_values[1] = -5.0;  //base_y
	// group_variable_values[2] = -5.0; //base_theta
	// group_variable_values[3] = 1.0;  //spine_height		
	// group_variable_values[4] = 0.5;  //left_shoulder_pan
	// group_variable_values[5] = -1.0;  //left_shoulder_lift
	// group_variable_values[6] = -1.0;  //left_upper_arm_roll_joint
	// group_variable_values[7] = -1.0;  //l_upper_arm_lift_joint
	// group_variable_values[8] = -1.0;  //l_upper_arm_roll_joint
	// group_variable_values[9] = -1.0;  //redundant_left
	// group_variable_values[10] = -1.0;  //
	// group_variable_values[11] = -1.0;  //right_shoulder_pan
	// group_variable_values[12] = -1.0;  //right_shoulder_lift
	// group_variable_values[13] = -1.0;  //right_upper_arm_roll_joint
	// group_variable_values[14] = -1.0;  //right_upper_arm_lift_joint
	// group_variable_values[15] = -1.0;  //right_upper_arm_roll_joint
	// group_variable_values[16] = -1.0;  //redundant_right
	// group_variable_values[17] = -10;  //
